...
<head>
    ...
    <style>
        ...
        * {{
        ...
        th:nth-child(2) {{ width: calc(50% - 40px); border-right: 1px solid var(--border); }}
        th:nth-child(3) {{ width: calc(50% - 40px); }}
        ...
        select {{
            flex: 2.5; /* Larger flex ratio for select */
            border: none;
            padding: 0.5rem 0.2rem 0.5rem 0.5rem; /* Reduced right padding */
            outline: none;
            color: var(--text-main);
            ...
            background-position: right 0.2rem center; /* Moved arrow icon to edge */
            background-size: 0.8em;
            padding-right: 1.2rem; /* Enough room for the new arrow icon position */
                        ...
                        <div class="slot-wrapper">
                            <div class="slot">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" placeholder="이름" value="${{slot.name}}">
                                </div>
                            </div>
